<template>
  <div>
    ...
    <trashed-message v-if="user.deleted_at" class="mb-6" @restore="restore"> O usuário foi removido. </trashed-message>
    <div class="max-w-3xl bg-white rounded-md shadow overflow-hidden">
      <form @submit.prevent="update">
        ...
        <div class="flex items-center px-8 py-4 bg-gray-50 border-t border-gray-100">
          <button v-if="!user.deleted_at" class="text-red-600 hover:underline" tabindex="-1" type="button" @click="destroy">Remover</button>
...
export default {
  ...
  methods: {
    ...
    restore() {
      if (confirm('Deseja realmente restaurar o usuário?')) {
